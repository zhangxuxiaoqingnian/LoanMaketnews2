package com.smileflowpig.money.common.widget.recycler;
...
public abstract class RecyclerAdapter<Data>
    ...
    public interface AdapterListener<Data> {
        // 当Cell点击的时候触发
        void onItemClick(ViewHolder holder, Data data, int pos);

        // 当Cell长按时触发
        void onItemLongClick(ViewHolder holder, Data data, int pos);
    }
