...
import com.smileflowpig.money.moneyplatfrom.guoshen.adapter.AmortizeAdapter;
import com.smileflowpig.money.moneyplatfrom.guoshen.adapter.LayoutAdapter;
...
public class HomeActivity extends PresenterActivity<HomeConreact.Presenter> implements HomeConreact.View{
    ...
    public void onclick(){
        ...
        if(flag){
            ...
            this.startActivityForResult(intent, Constant.Code.REQUEST_CODE);
        }
