...
public class ThreeFragment extends PresenterFragment implements OnRefreshLoadmoreListener{

    @BindView(R.id.threemess_rv)
    RecyclerView rv;
            ...
            public void onNext(MessageBean messageBean) {
                ...
                messageAdapter.setitemposition(new MessageAdapter.getItemposition() {
                    ...
                    public void success(int pos) {
                        MobclickAgent.onEvent(getActivity(), "informCard");
    ...
    protected int getContentLayoutId() {
        return R.layout.threemess_layout;
    }
