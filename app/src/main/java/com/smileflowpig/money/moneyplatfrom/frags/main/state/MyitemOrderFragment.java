...
import com.smileflowpig.money.moneyplatfrom.Adapter.MyAllAdapter;
...
import com.smileflowpig.money.moneyplatfrom.activities.MyHomeActivity;
...
public class MyitemOrderFragment extends PresenterFragment {

    private View inflate;
    private RecyclerView rv;
    private TextView fanull;
    private LinearLayout mylogin;
    private Button allmygo;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        inflate = LayoutInflater.from(getActivity()).inflate(R.layout.allmy_layout, container, false);
        return inflate;
    }

    @Override
    protected int getContentLayoutId() {
        return R.layout.allmy_layout;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        rv = (RecyclerView) inflate.findViewById(R.id.myrv);
        fanull = (TextView) inflate.findViewById(R.id.fanull);
        mylogin = (LinearLayout) inflate.findViewById(R.id.mylogin);
        allmygo = (Button) inflate.findViewById(R.id.allmygo);
        refreshlayout = (SmartRefreshLayout) inflate.findViewById(R.id.myrefreshlayout);
        layout = (RelativeLayout) inflate.findViewById(R.id.mylayout);
        rv.addItemDecoration(new DisplayUtils3.SpacesItemDecoration());

        getpopwindow();
        allmygo.setOnClickListener(new View.OnClickListener() {
            @Override
            ...
            public void onNext(AllMyBean o) {
                ...
                if(o!=null) {
                    ...
                    if (o.err.equals("没有数据")) {
                        ...
                        fanull.setVisibility(View.VISIBLE);
                    } else {
    ...
    public void onResume() {
        ...
        if (liulang) {
            ...
            fanull.setVisibility(View.GONE);
