...
public class AllOrderFragment extends PresenterFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        inflate = LayoutInflater.from(getActivity()).inflate(R.layout.all_layout, container,false);
        return inflate;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        rv = (RecyclerView) inflate.findViewById(R.id.allrv);
        alltext = (TextView) inflate.findViewById(R.id.alltext);
        go = (LinearLayout) inflate.findViewById(R.id.gologin);
        tologin = (Button) inflate.findViewById(R.id.allgo);
        refreshlayout = (SmartRefreshLayout) inflate.findViewById(R.id.allrefreshlayout);
        layout = (RelativeLayout) inflate.findViewById(R.id.alllayout);
