...
public class DividerItemDecoration2 extends RecyclerView.ItemDecoration {
    ...
    public DividerItemDecoration2(Context context, @DrawableRes int drawRes,
    ...
    public DividerItemDecoration2(Context context, @DrawableRes int horizontalDrawRes,
    ...
    public DividerItemDecoration2(@NonNull Drawable divider, int dividerSize) {
        this(divider, dividerSize, dividerSize);
    }

    public DividerItemDecoration2(@NonNull Drawable divider, int dividerWidth, int dividerHeight) {
        this(divider, divider, dividerWidth, dividerHeight);
    }

    public DividerItemDecoration2(@NonNull Drawable horizontalDivider,
