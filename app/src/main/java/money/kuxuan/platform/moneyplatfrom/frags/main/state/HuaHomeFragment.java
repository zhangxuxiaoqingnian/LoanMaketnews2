...
import money.kuxuan.platform.moneyplatfrom.Adapter.LikeAdapter;
import money.kuxuan.platform.moneyplatfrom.Adapter.LoseAdapter;
import money.kuxuan.platform.moneyplatfrom.Bean.CaseBean;
import money.kuxuan.platform.moneyplatfrom.LampView;
...
import money.kuxuan.platform.moneyplatfrom.activities.CityotherActivity;
import money.kuxuan.platform.moneyplatfrom.activities.DetailActivity;
import money.kuxuan.platform.moneyplatfrom.activities.DiscloseActivity;
import money.kuxuan.platform.moneyplatfrom.activities.MyDaiActivity;
import money.kuxuan.platform.moneyplatfrom.activities.TypeActivity;
import money.kuxuan.platform.moneyplatfrom.util.DisplayUtils5;
import money.kuxuan.platform.moneyplatfrom.util.DividerItemDecoration2;
import money.kuxuan.platform.moneyplatfrom.util.RequestCodeInfo;
        ...
        switch (v.getId()){
            ...
            case R.id.disclose:
                if(liulang){
                    ...
                    startActivityForResult(intent11, money.kuxuan.platform.moneyplatfrom.Constant.Code.REQUEST_CODE);
                }
            ...
            case R.id.appraisal:
                if(liulang){
                    ...
                    startActivityForResult(intent12, money.kuxuan.platform.moneyplatfrom.Constant.Code.REQUEST_CODE);
                }
