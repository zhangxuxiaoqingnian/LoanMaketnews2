...
//         持久化的数据进行初始化
    ...
    public static void decodeRspCode(RspModel model, DataSource.FailedCallback callback) {
        ...
        if (model == null) {
            decodeRspCode(com.smileflowpig.money.factory.R.string.no_data, callback);
            return;
        }
        ...
        switch (model.getErrno()) {
            ...
            case RspModel.FILE_UPLOAD_FAILED:
                decodeRspCode(com.smileflowpig.money.factory.R.string.data_upload_error, callback);
                break;
