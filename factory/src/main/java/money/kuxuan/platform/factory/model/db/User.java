...
public class User {
    ...
    public String getQq_idv() {
        return qq_idv;
    }

    public void setQq_idv(String qq_idv) {
        this.qq_idv = qq_idv;
    }
    ...
    public String getWx_accesstoken() {
        return wx_accesstoken;
    }

    public void setWx_accesstoken(String wx_accesstoken) {
        this.wx_accesstoken = wx_accesstoken;
    }

    public String getWx_createtime() {
        return wx_createtime;
    }

    public void setWx_createtime(String wx_createtime) {
        this.wx_createtime = wx_createtime;
    }

    public String getWx_refreshtoken() {
        return wx_refreshtoken;
    }

    public void setWx_refreshtoken(String wx_refreshtoken) {
        this.wx_refreshtoken = wx_refreshtoken;
    }
    ...
    public String getParlor_id() {
        return parlor_id;
    }

    public void setParlor_id(String parlor_id) {
